...
void setup()
{
  ...
  max86150Sensor1.setup(powerLevel, sampleAverage, ledMode, sampleRate, pulseWidth, adcRange); //Configure sensor. Use 6.4mA for LED drive
  ...
  max86150Sensor2.setup(powerLevel, sampleAverage, ledMode, sampleRate, pulseWidth, adcRange);
